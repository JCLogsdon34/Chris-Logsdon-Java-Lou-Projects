 ...
 */
package com.tsguild.useriotest;
...
public class UsingUserIO {
    ...
    public static void main(String[] args) {
        ...
        yourUserIO = new UserIOImpl(); // Uncomment this when you've pasted in your UserIO
        ...
        double loveJava = yourUserIO.readDouble("On a scale of 0 to 100, how much do you love java? ", -10, 10);
